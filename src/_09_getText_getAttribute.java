...
public class _09_getText_getAttribute {
    public static void main(String[] args) {
        ...
        System.out.println(subscribeButton.getCssValue("color")); // rgba(0, 0, 0, 1)
        System.out.println(subscribeButton.getCssValue("background-color")); // rgba(24, 24, 24, 1)
        System.out.println(subscribeButton.getCssValue("font-size")); // 13.3333px
        System.out.println(subscribeButton.getCssValue("font-family")); // Arial
        System.out.println(subscribeButton.getCssValue("margin")); // 0px
